...
@interface FastMotionViewController ()<AVManagerDelegate>
...
@implementation FastMotionViewController
- (void)viewDidLoad {
    [super viewDidLoad];
    [self creatControl];
...
- (void)creatControl
{
    ...
    [recordButton setTitle:@"录制一个20秒的快速视频" forState:UIControlStateNormal];
...
- (void)startRecordVideo:(UIButton *)btn
{
    ...
    btn.enabled = NO;
    [_manager startRecordVideoWithDuration:200 AndScale:0.25];
