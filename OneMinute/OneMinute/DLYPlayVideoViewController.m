...
- (void)setupUI{
    ...
    //播放
    UIButton * playButton = [[UIButton alloc]initWithFrame:CGRectMake(0, 0, 60, 60)];
    playButton.layer.cornerRadius = 30;
    playButton.clipsToBounds = YES;
    playButton.backgroundColor = RGBA(0, 0, 0, 0.4);
    playButton.tag = 11;
    [playButton addTarget:self action:@selector(onClickPlayOrPause:) forControlEvents:UIControlEventTouchUpInside];
    [playButton setImage:[UIImage imageWithIcon:@"\U0000e66a" inFont:ICONFONT size:23 color:RGB(255, 255, 255)] forState:UIControlStateNormal];
